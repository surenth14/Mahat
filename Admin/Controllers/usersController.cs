...
using Microsoft.AspNetCore.Authorization;
			  ...
			  {
					return await ApiClient.Get_ApiValues(getHttpClient(), "api/users/getById_alloweddevices?usersid="+usersid+"&loginUserID="+HttpContext.Session.GetString("MarketplacenewloginUserID"));
			 ...
			 if(strReturnMessage.Replace("\"", "").Contains("201.1")){
			  ...
			  public virtual async Task<IActionResult> EditPlatform(string usersid)
			  {
                    ...
                    if(HttpContext.Session.GetString("Marketplacenewrole_JSON") != null){
                            ...
                            try{
                                     var jsonObjusers = await ApiClient.Get_ApiValues(getHttpClient(), "api/users/getById_users?usersid="+usersid+"&loginUserID="+HttpContext.Session.GetString("MarketplacenewloginUserID"));
...
model.profilepicture = uploadFileName;
                                        ...
                                        if(model.profilepicture !=  null && model.profilepicture!="")
                                                    HttpContext.Session.SetString("Marketplacenewprofilepicture", model.profilepicture.ToString());
                                        strReturnMessage = await ApiClient.Post_ApiValuesGetString(getHttpClient(),"api/users/Update_Profile", model);
 									}
							}
							else
...
public virtual async Task<IActionResult> Suspend_Profile(string usersid)
			{
				...
				try
				{
						message = await ApiClient.Get_ApiValues(getHttpClient(), "api/users/Suspend_Profile?usersid="+usersid+"&loginUserID="+HttpContext.Session.GetString("MarketplacenewloginUserID"));
...
public virtual async Task<IActionResult> DeletePlatform(string usersid)
		  ...
		  public async Task<string> get_Transcript(string input)
          {
            try
            {
                string targetLanguage = HttpContext.Request.Cookies["MarketplacenewCurrentCulture"];
        ...
        public virtual IActionResult RoleAuthorizationFailed()
        {
	        ...
	        return RedirectToAction("Login");
                        ...
                        public virtual async Task<string> get_roles(string parentname)
                        {
		                        ...
		                        return await ApiClient.Get_ApiValues(getHttpClient(), "api/users/get_roles?roles="+HttpContext.Session.GetString("Marketplacenewuserrole") +"&parentname="+ parentname);
                        ...
                        HttpResponseMessage response_menu = await ApiClient.GET_ApiValuesGetRespnse(getHttpClient(), "api/users/get_project_Menu?viewactionroles="+ HttpContext.Session.GetString("Marketplacenewuserrole") + "&SubSystem=Admin");
                        ...
                        if (response_menu.IsSuccessStatusCode)
                        {
	                        ...
	                        HttpContext.Session.SetString("Marketplacenewmenu_JSON", menu_JSON);
	                        ...
	                        Response.Cookies.Append("MarketplacenewCurrentCulture", culture, new CookieOptions
                        {
...
[AllowAnonymous]
			public virtual async Task<IActionResult> Login(userloginModel model)
			{
				...
				try
				{
						...
						if (dt.Rows.Count >0)
						{
							HttpContext.Session.SetString("Marketplacenewusername", dt.Rows[0]["username"].ToString());
							HttpContext.Session.SetString("MarketplacenewloginUserID", dt.Rows[0]["usersid"].ToString());
							
							HttpContext.Session.SetString("Marketplacenewtoken", dt.Rows[0]["token"].ToString());
							HttpContext.Session.SetString("Marketplacenewuserrole", dt.Rows[0]["userrole"].ToString());
                            if(dt.Rows[0]["profilepicture"].ToString()!=null && dt.Rows[0]["profilepicture"].ToString()!="")
                            HttpContext.Session.SetString("Marketplacenewprofilepicture", dt.Rows[0]["profilepicture"].ToString());
                            else
                            HttpContext.Session.SetString("Marketplacenewprofilepicture", baseUrl+"/Icon_set/User.png");

                            HttpContext.Session.SetString("Marketplacenewtenantlogo", baseUrl+"/images/logo.png");
...
HttpContext.Session.SetString("Marketplacenewshowtenant", "N");
                        if (dt.Rows[0]["viewertenantids"].ToString().Contains(","))
                        {
                            HttpContext.Session.SetString("Marketplacenewshowtenant", "Y");
                        }

                                                                               HttpContext.Session.SetString("Marketplacenewchoosedtenantname", dt.Rows[0]["tenantname"].ToString());

                                                                         
																			HttpContext.Session.SetString("Marketplacenewchoosedtenantid", dt.Rows[0]["tenantid"].ToString());
																			...
																			} else
						                                                    {
                                                                                ...
                                                                                HttpContext.Session.SetString("Marketplacenewchoosedtenantid", "");
                                                                             }
							...
							if (response_roles.IsSuccessStatusCode)
							{
                                ...
                                if(dt_roles.Rows.Count ==0){
                                        ViewData["message"]="You are not authorized to access Marketplacenew , Please contact administrator";
                                        return View(model); 
                                }
            
								HttpContext.Session.SetSession("Marketplacenewroles", dt_roles);
								HttpContext.Session.SetString("Marketplacenewrole_JSON", role_JSON);
							...
							if (response_menu.IsSuccessStatusCode)
							{
								...
								string menu_JSON = await response_menu.Content.ReadAsStringAsync();
								HttpContext.Session.SetSession("Marketplacenewmenu", dt_menu);
								 var assembly = typeof(usersController).Assembly;
                                    System.Resources.ResourceManager _resourceManager = new System.Resources.ResourceManager("Admin.Resource", assembly);
				...
				if(message=="Login Success"){
					...
					return RedirectToAction("UpdateProfile","users", new {@usersid=HttpContext.Session.GetString("MarketplacenewloginUserID")});
...
HttpContext.Session.SetString("Marketplacenewshowtenant", "N");
                        if (dt.Rows[0]["viewertenantids"].ToString().Contains(","))
                        {
							...
							if (response_roles.IsSuccessStatusCode)
							{
								...
								DataTable dt_roles = await response_roles.Content.ReadAsAsync<DataTable>();
								if(dt_roles.Rows.Count ==0){
                                        message="You are not authorized to access Marketplacenew , Please contact administrator";
                    ...
                    {
                        message = "Marketplacenew's API Response Failed";
                    }
                }
                else
                {
...
;
		...
		{
			string dashmenu = await ApiClient.Get_ApiValues(getHttpClient(), "api/users/get_Dashboard_Items?viewactionroles=" + HttpContext.Session.GetString("Marketplacenewuserrole"));
			if (dashmenu != "")
			{
				var assembly = typeof(usersController).Assembly;
				System.Resources.ResourceManager _resourceManager = new System.Resources.ResourceManager("Admin.Resource", assembly);
...
)
			{
				...
				return await ApiClient.Get_ApiValues(getHttpClient(), "api/users/List_of_User_Profiles?tenantid="+tenantid+"&loginUserID="+HttpContext.Session.GetString("MarketplacenewloginUserID")
);
			}
