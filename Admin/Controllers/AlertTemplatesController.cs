...
using Microsoft.AspNetCore.Authorization;
				...
				//This code generated from staging Powered by Mahat, Source Machine : stg , Build Number : #2024-07-004 (Updated on 07/07/2024 22:07) on 05/06/2025 11:28:23
			 ...
			 if(strReturnMessage.Replace("\"", "").Contains("201.1")){
			  ...
			  public virtual async Task<IActionResult> Update_Alert_Templates(string AlertTemplatesid)
			  {
                    ...
                    if(HttpContext.Session.GetString("Marketplacenewrole_JSON") != null){
                            ...
                            try{
                                     var jsonObjAlertTemplates = await ApiClient.Get_ApiValues(getHttpClient(), "api/AlertTemplates/getById_AlertTemplates?AlertTemplatesid="+AlertTemplatesid+"&loginUserID="+HttpContext.Session.GetString("MarketplacenewloginUserID"));
...
public virtual async Task<IActionResult> Remove_Alert_Templates(string AlertTemplatesid)
			{
				...
				try
				{
						message = await ApiClient.Get_ApiValues(getHttpClient(), "api/AlertTemplates/Remove_Alert_Templates?AlertTemplatesid="+AlertTemplatesid+"&loginUserID="+HttpContext.Session.GetString("MarketplacenewloginUserID"));
...
,string alerttype
)
			{
				...
				return await ApiClient.Get_ApiValues(getHttpClient(), "api/AlertTemplates/Alert_Templates_List?entityname="+entityname+"&entityaction="+entityaction+"&alerttype="+alerttype+"&loginUserID="+HttpContext.Session.GetString("MarketplacenewloginUserID")
);
			}
