...
using Microsoft.AspNetCore.Authorization;
				...
				//This code generated from staging Powered by Mahat, Source Machine : stg , Build Number : #2024-07-004 (Updated on 07/07/2024 22:07) on 05/06/2025 11:28:25
			 ...
			 if(strReturnMessage.Replace("\"", "").Contains("201.1")){
			  ...
			  public virtual async Task<IActionResult> Update_MailLog(string MailLogsid)
			  {
                    ...
                    if(HttpContext.Session.GetString("Marketplacenewrole_JSON") != null){
                            ...
                            try{
                                     var jsonObjMailLogs = await ApiClient.Get_ApiValues(getHttpClient(), "api/MailLogs/getById_MailLogs?MailLogsid="+MailLogsid+"&loginUserID="+HttpContext.Session.GetString("MarketplacenewloginUserID"));
...
public virtual async Task<IActionResult> Remove_MailLog(string MailLogsid)
			{
				...
				try
				{
						message = await ApiClient.Get_ApiValues(getHttpClient(), "api/MailLogs/Remove_MailLog?MailLogsid="+MailLogsid+"&loginUserID="+HttpContext.Session.GetString("MarketplacenewloginUserID"));
...
, int? pagesize=100 , int? pagenumber=0,string searchterm="",string sortFieldsJson="")
			        {
				        ...
				        return await ApiClient.Get_ApiValues(getHttpClient(), "api/MailLogs/MailLogs_List?entityname="+entityname+"&mailfor="+mailfor+"&loginUserID="+HttpContext.Session.GetString("MarketplacenewloginUserID")
