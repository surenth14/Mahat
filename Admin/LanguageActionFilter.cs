...
namespace Admin
{
    ...
    public class LanguageActionFilter : IActionFilter
    {
        ...
        public void OnActionExecuting(ActionExecutingContext context)
        {
            ...
            if (context.HttpContext.Request.Cookies.ContainsKey("MarketplacenewCurrentCulture"))
            {
                culture = context.HttpContext.Request.Cookies["MarketplacenewCurrentCulture"];
            }
