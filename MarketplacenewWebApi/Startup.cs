...
services.AddSwaggerGen(s =>
        {
            ...
            {
                Version = "v1",
                Title = "Marketplacenew",
                Description = "Marketplacenew Apis",
...
if(env.IsDevelopment())
            {
                ...
                app.UseSwaggerUI(c =>
                {
                    c.SwaggerEndpoint("/swagger/v1/swagger.json", "Marketplacenew");
                    c.RoutePrefix = "";
            ...
            {
                    var basePath = "/Marketplacenew/MarketplacenewWebApi";
                    app.UseSwagger(c =>
                    {
                    ...
                    {
	                    c.RoutePrefix = "";
	                    c.SwaggerEndpoint("/Marketplacenew/MarketplacenewWebApi/swagger/v1/swagger.json", "Marketplacenew");
                    });
